...
author: Beshkia Kvarnstrom, Nikoleta Emanouilidi, Evan McLaughlin, Victor Torres &
  Vladimir Nimchenko
date: "2024-12-03"
output:
  html_document:
...
random_forest_predictions$ph2 <- predict(random_forest_model, newdata = test_x)
library(DT)
library(DataExplorer)
random_forest_predictions$ph2 %>% tibble::enframe(name = NULL) %>% datatable()
plot_histogram(random_forest_predictions$ph2)
write.csv(random_forest_predictions$ph2, "StudentPHPredictions3.csv")
