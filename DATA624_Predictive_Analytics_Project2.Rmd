...
author: "Beshkia Kvarnstrom, Nikoleta Emanouilidi, Evan McLaughlin, Victor Torres & Vladimir Nimchenko"
date: "2024-12-03"
output: pdf_document
---
...
```{r Variable Importance, message=FALSE, warnings=FALSE}
...
# Forecast
```{r}
random_forest_predictions <- predict(random_forest_model, test_x)
predictions_tibble <- tibble(Predicted_PH = random_forest_predictions)
print(predictions_tibble)

ggplot(predictions_tibble, aes(x = Predicted_PH)) +
  geom_histogram(binwidth = 0.1, fill = "blue", color = "black", alpha = 0.7) +
  labs(title = "Distribution of Predicted PH", 
       x = "Predicted PH", 
       y = "Frequency") +
  theme_minimal()

write.csv(test_x$PH, "StudentPHPredictions.csv")
